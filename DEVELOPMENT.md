...
│   ├── Hartonomous.Sql.Bridge/   # Bridge library (.NET Standard 2.0)
...
```powershell
# Bridge library
dotnet build src\Hartonomous.Sql.Bridge\Hartonomous.Sql.Bridge.csproj
...
**Solution:** Bridge library uses newer packages. Ensure .NET Standard 2.0 compatibility.
