...
- **Key Assets:**
  ...
  - Migrations:
    ...
    - `20251101143425_AddSpatialAndVectorIndexes`: Adds `idx_spatial_fine`, `idx_spatial_coarse`, and DiskANN vector index for `Embeddings_DiskANN` when available, guarding with `IF EXISTS` checks to keep repeatable runs safe.
