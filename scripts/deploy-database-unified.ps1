...
# CLR assembly dependencies (MUST be deployed in dependency order)
$script:CLRAssemblies = @(
    @{ Name = "System.Numerics.Vectors"; Path = "dependencies\System.Numerics.Vectors.dll"; Hash = $null }
    @{ Name = "MathNet.Numerics"; Path = "dependencies\MathNet.Numerics.dll"; Hash = $null }
    @{ Name = "Newtonsoft.Json"; Path = "dependencies\Newtonsoft.Json.dll"; Hash = $null }
