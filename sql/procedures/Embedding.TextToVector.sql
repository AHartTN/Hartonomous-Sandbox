-- Text to vector embedding pipeline using TF-IDF vocabulary projection.
GO
...
BEGIN
    ...
    SET @ModelName = COALESCE(@ModelName, 'tfidf_vocabulary_embedding');
    ...
    DECLARE @outputMetadata NVARCHAR(MAX) = JSON_OBJECT(
        ...
        'unknown_tokens': @unknownTokens,
        'normalization': 'l2',
        'strategy': 'tfidf_vocabulary_projection'
    );
