...
public class AtomConfiguration : IEntityTypeConfiguration<Atom>
{
    public void Configure(EntityTypeBuilder<Atom> builder)
    {
        ...
        builder.HasIndex(e => new { e.ContentType })
            .HasDatabaseName("IX_Atom_ContentType")
            ;

        builder.HasIndex(e => new { e.Modality, e.Subtype })
            .HasDatabaseName("IX_Atom_Modality")
            ;
        ...
        builder.HasIndex(e => new { e.TenantId, e.Modality })
            .HasDatabaseName("IX_Atom_TenantId")
            ;

        builder.HasIndex(e => new { e.ContentHash })
            .HasDatabaseName("UX_Atom_ContentHash")
            .IsUnique()
            ;
    }
}
