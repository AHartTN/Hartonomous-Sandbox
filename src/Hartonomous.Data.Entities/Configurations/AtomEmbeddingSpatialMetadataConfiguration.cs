...
public class AtomEmbeddingSpatialMetadataConfiguration : IEntityTypeConfiguration<AtomEmbeddingSpatialMetadata>
{
    public void Configure(EntityTypeBuilder<AtomEmbeddingSpatialMetadata> builder)
    {
        builder.ToTable("AtomEmbeddingSpatialMetadata", "dbo");
        ...
        builder.HasIndex(e => new { e.SpatialBucketX, e.SpatialBucketY, e.SpatialBucketZ, e.HasZ })
            .HasDatabaseName("UX_AtomEmbeddingSpatialMetadata_BucketXYZ")
            .IsUnique()
            ;
    }
}
