...
public class AttentionInferenceResultsConfiguration : IEntityTypeConfiguration<AttentionInferenceResults>
{
    public void Configure(EntityTypeBuilder<AttentionInferenceResults> builder)
    {
