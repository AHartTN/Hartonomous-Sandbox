...
public class AutonomousComputeJobConfiguration : IEntityTypeConfiguration<AutonomousComputeJob>
{
    public void Configure(EntityTypeBuilder<AutonomousComputeJob> builder)
    {
