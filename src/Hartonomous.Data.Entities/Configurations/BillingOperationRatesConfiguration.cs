...
public class BillingOperationRatesConfiguration : IEntityTypeConfiguration<BillingOperationRates>
{
    public void Configure(EntityTypeBuilder<BillingOperationRates> builder)
    {
