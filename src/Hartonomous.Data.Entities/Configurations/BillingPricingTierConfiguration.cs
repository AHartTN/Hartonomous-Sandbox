...
public class BillingPricingTierConfiguration : IEntityTypeConfiguration<BillingPricingTier>
{
    public void Configure(EntityTypeBuilder<BillingPricingTier> builder)
    {
        builder.ToTable("BillingPricingTier", "dbo");
