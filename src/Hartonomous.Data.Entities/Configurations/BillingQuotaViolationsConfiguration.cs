...
public class BillingQuotaViolationsConfiguration : IEntityTypeConfiguration<BillingQuotaViolations>
{
    public void Configure(EntityTypeBuilder<BillingQuotaViolations> builder)
    {
