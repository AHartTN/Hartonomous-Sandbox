...
public class BillingRatePlansConfiguration : IEntityTypeConfiguration<BillingRatePlans>
{
    public void Configure(EntityTypeBuilder<BillingRatePlans> builder)
    {
        builder.ToTable("BillingRatePlans", "dbo");
