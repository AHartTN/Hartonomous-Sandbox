...
public class BillingTenantQuotasConfiguration : IEntityTypeConfiguration<BillingTenantQuotas>
{
    public void Configure(EntityTypeBuilder<BillingTenantQuotas> builder)
    {
