...
public class BillingTenantQuotumConfiguration : IEntityTypeConfiguration<BillingTenantQuotum>
{
    public void Configure(EntityTypeBuilder<BillingTenantQuotum> builder)
    {
        builder.ToTable("BillingTenantQuota", "dbo");
