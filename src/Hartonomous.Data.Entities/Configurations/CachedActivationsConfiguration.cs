...
public class CachedActivationsConfiguration : IEntityTypeConfiguration<CachedActivations>
{
    public void Configure(EntityTypeBuilder<CachedActivations> builder)
    {
