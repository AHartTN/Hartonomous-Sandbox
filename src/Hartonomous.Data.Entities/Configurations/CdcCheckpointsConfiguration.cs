...
public class CdcCheckpointsConfiguration : IEntityTypeConfiguration<CdcCheckpoints>
{
    public void Configure(EntityTypeBuilder<CdcCheckpoints> builder)
    {
        builder.ToTable("CdcCheckpoints", "dbo");
