...
public class CicdbuildConfiguration : IEntityTypeConfiguration<Cicdbuild>
{
    public void Configure(EntityTypeBuilder<Cicdbuild> builder)
    {
        builder.ToTable("CICDBuild", "dbo");
