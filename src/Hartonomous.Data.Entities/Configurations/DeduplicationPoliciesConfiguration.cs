...
public class DeduplicationPoliciesConfiguration : IEntityTypeConfiguration<DeduplicationPolicies>
{
    public void Configure(EntityTypeBuilder<DeduplicationPolicies> builder)
    {
