...
public class EventGenerationResultConfiguration : IEntityTypeConfiguration<EventGenerationResult>
{
    public void Configure(EntityTypeBuilder<EventGenerationResult> builder)
    {
