...
public class EventHubCheckpointsConfiguration : IEntityTypeConfiguration<EventHubCheckpoints>
{
    public void Configure(EntityTypeBuilder<EventHubCheckpoints> builder)
    {
