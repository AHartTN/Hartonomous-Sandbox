...
public class InferenceRequestsConfiguration : IEntityTypeConfiguration<InferenceRequests>
{
    public void Configure(EntityTypeBuilder<InferenceRequests> builder)
    {
