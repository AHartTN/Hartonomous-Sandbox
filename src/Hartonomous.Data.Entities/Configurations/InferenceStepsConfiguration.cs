...
public class InferenceStepsConfiguration : IEntityTypeConfiguration<InferenceSteps>
{
    public void Configure(EntityTypeBuilder<InferenceSteps> builder)
    {
        builder.ToTable("InferenceSteps", "dbo");
