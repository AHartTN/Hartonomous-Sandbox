...
public class IngestionJobAtomsConfiguration : IEntityTypeConfiguration<IngestionJobAtoms>
{
    public void Configure(EntityTypeBuilder<IngestionJobAtoms> builder)
    {
