...
public class ModelLayerConfiguration : IEntityTypeConfiguration<ModelLayer>
{
    ...
    {
        builder.ToTable("ModelLayers", "dbo");
        ...
        builder.HasIndex(e => new { e.LayerAtomId })
            .HasDatabaseName("IX_ModelLayers_LayerAtomId")
            ;

        builder.HasIndex(e => new { e.LayerType })
            .HasDatabaseName("IX_ModelLayers_LayerType")
            ;

        builder.HasIndex(e => new { e.ModelId, e.Mmin, e.Mmax })
        ...
        builder.HasIndex(e => new { e.ModelId, e.Zmin, e.Zmax })
