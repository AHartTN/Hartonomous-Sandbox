...
public class ProvenanceAuditResultConfiguration : IEntityTypeConfiguration<ProvenanceAuditResult>
{
    public void Configure(EntityTypeBuilder<ProvenanceAuditResult> builder)
    {
