...
public class ProvenanceValidationResultsConfiguration : IEntityTypeConfiguration<ProvenanceValidationResults>
{
    public void Configure(EntityTypeBuilder<ProvenanceValidationResults> builder)
    {
