...
public class SelfConsistencyResultsConfiguration : IEntityTypeConfiguration<SelfConsistencyResults>
{
    public void Configure(EntityTypeBuilder<SelfConsistencyResults> builder)
    {
