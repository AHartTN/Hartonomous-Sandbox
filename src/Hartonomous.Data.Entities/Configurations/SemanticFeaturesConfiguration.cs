...
public class SemanticFeaturesConfiguration : IEntityTypeConfiguration<SemanticFeatures>
{
    public void Configure(EntityTypeBuilder<SemanticFeatures> builder)
    {
        ...
        builder.HasOne(d => d.AtomEmbedding)
            .WithOne(p => p.SemanticFeatures)
            .HasForeignKey<SemanticFeatures>(e => new { e.AtomEmbeddingId })
            ;
