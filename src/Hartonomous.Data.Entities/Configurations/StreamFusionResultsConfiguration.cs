...
public class StreamFusionResultsConfiguration : IEntityTypeConfiguration<StreamFusionResults>
{
    public void Configure(EntityTypeBuilder<StreamFusionResults> builder)
    {
