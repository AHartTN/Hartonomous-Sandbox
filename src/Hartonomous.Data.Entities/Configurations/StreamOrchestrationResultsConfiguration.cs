...
public class StreamOrchestrationResultsConfiguration : IEntityTypeConfiguration<StreamOrchestrationResults>
{
    public void Configure(EntityTypeBuilder<StreamOrchestrationResults> builder)
    {
