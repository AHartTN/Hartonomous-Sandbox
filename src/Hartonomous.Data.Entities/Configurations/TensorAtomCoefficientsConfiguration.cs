...
public class TensorAtomCoefficientsConfiguration : IEntityTypeConfiguration<TensorAtomCoefficients>
{
    public void Configure(EntityTypeBuilder<TensorAtomCoefficients> builder)
    {
