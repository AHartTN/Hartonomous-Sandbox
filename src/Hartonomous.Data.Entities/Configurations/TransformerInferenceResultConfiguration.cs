...
public class TransformerInferenceResultConfiguration : IEntityTypeConfiguration<TransformerInferenceResult>
{
    public void Configure(EntityTypeBuilder<TransformerInferenceResult> builder)
    {
