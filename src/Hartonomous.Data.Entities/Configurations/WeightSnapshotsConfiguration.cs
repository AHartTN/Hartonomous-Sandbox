...
public class WeightSnapshotsConfiguration : IEntityTypeConfiguration<WeightSnapshots>
{
    public void Configure(EntityTypeBuilder<WeightSnapshots> builder)
    {
        builder.ToTable("WeightSnapshots", "dbo");
        ...
        builder.HasIndex(e => new { e.SnapshotName })
            .HasDatabaseName("UQ__WeightSn__FAC0EC4AED1BB930")
            .IsUnique()
            ;
    }
}
