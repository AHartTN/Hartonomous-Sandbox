...
public partial class Models : IModels
{
    ...
    public virtual ICollection<InferenceRequests> InferenceRequests { get; set; } = new List<InferenceRequests>();
    ...
    public virtual ICollection<WeightSnapshots> WeightSnapshots { get; set; } = new List<WeightSnapshots>();
}
