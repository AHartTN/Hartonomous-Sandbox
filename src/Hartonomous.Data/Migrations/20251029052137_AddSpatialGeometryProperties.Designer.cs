...
namespace Hartonomous.Data.Migrations
{
    ...
    [Migration("20251029052137_AddSpatialGeometryProperties")]
    partial class AddSpatialGeometryProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hartonomous.Core.Entities.Embedding", b =>
                {
                    ...
                    b.HasIndex("SpatialCoarse")
                        .HasDatabaseName("idx_spatial_coarse");

                    b.HasIndex("SpatialGeometry")
