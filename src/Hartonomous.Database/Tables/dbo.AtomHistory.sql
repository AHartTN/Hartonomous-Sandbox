-- ==================================================================
-- AtomHistory: Temporal History Table for System-Versioned Atoms
-- ==================================================================
...
(
    ...
    INDEX [IX_AtomHistory_Period] CLUSTERED ([CreatedAt], [ModifiedAt])
);
GO

-- Index for point-in-time queries by ContentHash
CREATE NONCLUSTERED INDEX [IX_AtomHistory_ContentHash]
    ON [dbo].[AtomHistory]([ContentHash], [CreatedAt], [ModifiedAt]);
GO
...
EXEC sys.sp_addextendedproperty 
    ...
    @level1type = N'TABLE', @level1name = N'AtomHistory';
GO
