CREATE TABLE [dbo].[CachedActivations] (
    ...
    CONSTRAINT [FK_CachedActivations_ModelLayers_LayerId] FOREIGN KEY ([LayerId]) REFERENCES [dbo].[ModelLayers] ([LayerId]) ON DELETE CASCADE,
    CONSTRAINT [FK_CachedActivations_Models_ModelId] FOREIGN KEY ([ModelId]) REFERENCES [dbo].[Models] ([ModelId])
);
